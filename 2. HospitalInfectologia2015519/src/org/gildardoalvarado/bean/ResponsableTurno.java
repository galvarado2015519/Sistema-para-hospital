...
public class ResponsableTurno {
    ...
    public ResponsableTurno(int codigoResponsableTurno, String nombresResponsable, String apellidosResponsable, String telefonoPersonal, int codigoArea, int codigoCargo) {
    ...
    public String toString(){
        return getNombresResponsable() + ", " + getApellidosResponsable();
    }
}
